...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (empty($errors)) {
        ...
        try { 
            ...
            $mail->setFrom(""); 
            $mail->addAddress(""); 
            $mail->Subject = "Vyplnen kontaktni formular"; 
        ...
        <main>
            ...
            <section class="form">
                <form action="contact.php" method="POST">
                    <input type="text" name="first_name" placeholder="Křestní jméno" value="<?= $first_name; ?>" required><br>
                    <input type="text" name="second_name" placeholder="Příjmení" value="<?= $second_name; ?>" required><br>
